(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@web3-react/injected-connector'), require('@web3-react/walletconnect-connector'), require('ethers'), require('react'), require('@web3-react/core'), require('buffer'), require('react-dom'), require('@prismicio/react'), require('@prismicio/client')) :
  typeof define === 'function' && define.amd ? define(['exports', '@web3-react/injected-connector', '@web3-react/walletconnect-connector', 'ethers', 'react', '@web3-react/core', 'buffer', 'react-dom', '@prismicio/react', '@prismicio/client'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["airdao-components-and-tools"] = {}, global.injectedConnector, global.walletconnectConnector, global.ethers, global.React, global.core, global.buffer, global.ReactDOM, global.react, global.prismic));
})(this, (function (exports, injectedConnector, walletconnectConnector, ethers, React, core, buffer, reactDom, react, prismic) { 'use strict';
  ...
  var changeChainId = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(provider, selectedNetwork) {
      var hexChainId;
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              hexChainId = ethers.utils.hexValue(+selectedNetwork.chainId);
              _context.prev = 1;
              _context.next = 4;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                ambNetwork = getCurrentAmbNetwork();
  ...
  */
  ...
  var WalletConnectLogo = function WalletConnectLogo() {
    return /*#__PURE__*/jsxRuntime.exports.jsx("svg", {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: /*#__PURE__*/jsxRuntime.exports.jsx("path", {
        d: "M5.7322 3.2419C10.2984 -1.08063 17.7016 -1.08063 22.2679 3.2419L22.8174 3.76211C23.0457 3.97827 23.0457 4.32865 22.8174 4.54481L20.9375 6.32438C20.8233 6.43245 20.6382 6.43245 20.5241 6.32438L19.7678 5.60852C16.5823 2.59298 11.4176 2.59298 8.23214 5.60852L7.42226 6.37514C7.30814 6.48321 7.12308 6.48321 7.00889 6.37514L5.12903 4.59557C4.90065 4.37941 4.90065 4.02903 5.12903 3.81287L5.7322 3.2419ZM26.1556 6.92229L27.8288 8.50608C28.0571 8.72223 28.0571 9.07262 27.8288 9.28878L20.2846 16.4305C20.0563 16.6466 19.6861 16.6466 19.4578 16.4305L14.1034 11.3618C14.0463 11.3078 13.9538 11.3078 13.8967 11.3618L8.5424 16.4305C8.3141 16.6466 7.9439 16.6466 7.7156 16.4305L0.171232 9.2887C-0.0570773 9.07255 -0.0570773 8.72216 0.171232 8.50601L1.84435 6.92215C2.07266 6.70607 2.44282 6.70607 2.67113 6.92215L8.02564 11.9909C8.08266 12.045 8.17519 12.045 8.23229 11.9909L13.5865 6.92215C13.8148 6.70607 14.185 6.70607 14.4133 6.92215L19.7678 11.9909C19.8249 12.045 19.9174 12.045 19.9745 11.9909L25.3288 6.92229C25.5572 6.70614 25.9273 6.70614 26.1556 6.92229Z",
        fill: "#3396FF"
      })
    });
  };
  ...
  var AddressBlock = function AddressBlock(_ref) {
    ...
    var connectorName = React.useMemo(function () {
      return connector.constructor.name;
    }, [connector]);
    return /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
      className: "address-block",
      children: [/*#__PURE__*/jsxRuntime.exports.jsxs("div", {
        className: "address-block__wallet-icon",
        children: [connectorName === 'InjectedConnector' ? /*#__PURE__*/jsxRuntime.exports.jsx(Metamask, {}) : null, connectorName === 'WalletConnectConnector' ? /*#__PURE__*/jsxRuntime.exports.jsx(WalletConnectLogo, {}) : null]
