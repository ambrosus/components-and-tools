...
import { useSinglePrismicDocument, PrismicText, PrismicProvider } from '@prismicio/react';
...
var defaultInjectedConnector = new InjectedConnector({
  supportedChainIds: [+ambNetwork.chainId]
});
var defaultWalletConnectConnector = new WalletConnectConnector({
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            hexChainId = utils.hexValue(+selectedNetwork.chainId);
            _context.prev = 1;
            _context.next = 4;
...
var ConnectWalletButtonLayout = function ConnectWalletButtonLayout(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.exports.jsxs("button", {
    ...
    children: [/*#__PURE__*/React__default.createElement(logo, {
      alt: 'metamask logo',
...
var WalletModal = function WalletModal(_ref) {
  ...
  return isOpen && /*#__PURE__*/createPortal( /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
...
var usePrismicPageData = function usePrismicPageData(type) {
  var _useSinglePrismicDocu = useSinglePrismicDocument(type),
...
var AddressBlock = function AddressBlock(_ref) {
  ...
  var connectorName = useMemo(function () {
  ...
  return /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.exports.jsxs("button", {
      ...
      children: [/*#__PURE__*/jsxRuntime.exports.jsx("div", {
        ...
        children: /*#__PURE__*/jsxRuntime.exports.jsx(PrismicText, {
...
var MenuBody = function MenuBody(_ref) {
  ...
  var _useState = useState(initHidden ? false : window.innerWidth > 1050),
    _useState2 = _slicedToArray(_useState, 2),
    isOpen = _useState2[0],
    setIsOpen = _useState2[1];
...
var Menu = function Menu(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.exports.jsxs(PrismicProvider, {
    client: client,
...
export { Menu, MetamaskConnectButton, WalletConnectButton, WalletModal, allAmbNetworksConfig, changeChainId, defaultInjectedConnector, defaultWalletConnectConnector, getCurrentAmbNetwork, useAuthorization, useAutoLogin };
